...
这一段对应 [react-prompt.md](https://github.com/leondt1/ai-agent-tutorial/blob/main/examples/04-react/react-prompt.md)。它不是可执行代码，而是一个可以复制到模型对话里的演示 prompt。
...
这一章对应的可运行代码在 [react-agent.ts](https://github.com/leondt1/ai-agent-tutorial/blob/main/examples/04-react/react-agent.ts)。
